...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	function animiateButton() {
		$("#open-button").animate({"width": "80px"}, 500);
		$("#open-button").animate({"width": "40px"}, 500);

		$(".ifc-down4").animate({"top": "10px"}, 500);
		$(".ifc-down4").animate({"top": "0px"}, 500);


		setTimeout(animiateButton, 100);
	}
	setTimeout(animiateButton, 2000);
